...
//   @GetMapping("/deal")
//   public ResponseEntity<List<HouseDealDto>> deal(@RequestParam("apt_code") int aptCode) throws Exception {
//      return new ResponseEntity<List<HouseDealDto>>(happyHouseMapService.getDealInApt(aptCode), HttpStatus.OK);
//   }
//   
//   @GetMapping("/apt-search-by-date")
//   public ResponseEntity<List<HouseDealDto>> aptSearch(@RequestParam("apt_code") int aptCode) throws Exception {
//      return new ResponseEntity<List<HouseDealDto>>(happyHouseMapService.getDealInApt(aptCode), HttpStatus.OK);
//   }
